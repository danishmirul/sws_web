...
class NotifiedWheelchairs extends StatelessWidget {
  const NotifiedWheelchairs({
    Key key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Responsive(
          mobile: NotifiedWheelchairCardGridView(
            crossAxisCount: _size.width < 650 ? 2 : 4,
            childAspectRatio: _size.width < 650 ? 1.3 : 1,
          ),
          tablet: NotifiedWheelchairCardGridView(),
          desktop: NotifiedWheelchairCardGridView(
...
class NotifiedWheelchairCardGridView extends StatelessWidget {
  const NotifiedWheelchairCardGridView({
    Key key,
